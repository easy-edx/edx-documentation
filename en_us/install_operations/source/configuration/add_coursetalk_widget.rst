...
edX. When you add the CourseTalk widget, it will be visible for all courses.
...
reviews that other learners have written, right on the **Home** page in the
course or on the course About page. Learners can write or read reviews of your
course at any time.
...
#. On the **Select course talk widget configuration to change** page, select
   **Add course talk widget configuration** in the upper right corner.
