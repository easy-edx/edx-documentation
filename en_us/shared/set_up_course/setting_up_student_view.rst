...
dashboards and on the course **About** page. For more information, see
:ref:`SFD Dashboard Settings Profile`.
...
.. only:: Open_edX
  ...
  platform, the **About** page also includes the CourseTalk widget. Learners
  who have enrolled in your course use this widget to write reviews of your
  course. Learners access the CourseTalk widget from the course **Home** page
  in the LMS. For more information, see :ref:`installation:Add CourseTalk`.
